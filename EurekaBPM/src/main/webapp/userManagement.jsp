...
<body ng-app="myApp" class="ng-cloak">
	<div class="generic-container" ng-controller="PeopleController as ctrl">
				...
				<form ng-submit="ctrl.submit()" name="myForm"
					class="form-horizontal">
						...
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<input type="text" ng-model="ctrl.people.soeid" id="uname"
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<input type="text" ng-model="ctrl.people.nombre" id="address"
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<input type="email" ng-model="ctrl.people.apellidoPaterno" id="email"
					...
					<div class="row">
						<div class="form-actions floatRight">
							<input type="submit" value="{{!ctrl.people.soeid ? 'Add' : 'Update'}}"
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr ng-repeat="u in ctrl.users">
							<td><span ng-bind="u.soeid"></span></td>
							<td><span ng-bind="u.nombre"></span></td>
							<td><span ng-bind="u.apellidoPaterno"></span></td>
							<td>
								<button type="button" ng-click="ctrl.edit(u.soeid)"
									class="btn btn-success custom-width">Edit</button>
								<button type="button" ng-click="ctrl.remove(u.soeid)"
	...
	<script
		src="<c:url value='/resources/app/controller/user_controller.js' />"></script>
</body>
</html>